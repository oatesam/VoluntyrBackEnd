...
from .views import EventsAPIView, ObtainTokenPairView, OrganizationAPIView, VolunteerAPIView, CheckEmailAPIView, OrganizationCreateAPIView
...
urlpatterns = [
    ...
    path('signup/organization/', OrganizationCreateAPIView.as_view()),
